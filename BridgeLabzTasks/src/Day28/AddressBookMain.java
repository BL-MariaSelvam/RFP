...
public class AddressBookMain {
	...
	public static void main(String args[]) {
		...
		do {
			...
			case 2:
				...
				if (selectedBookName != null) {
				    addressBookMenu(sc, selectedBookName, addressBookMap, addBookName); // pass the name here
				}
				break;
			case 3:
		...
		private static void addressBookMenu(Scanner sc,AddressBook addressBook, Map<String, AddressBook> addressBookMap,String addBookName) {
		...
		do {
			...
			System.out.println("16.Save AddressBook to CSV");
			System.out.println("17.Load AddressBook from CSV");
			System.out.println("18.Save AddressBook to JSON");
			System.out.println("19.Load AddressBook from JSON");
			...
			case 16: // Save AddressBook to CSV
			    try {
			        AddressBookCSVIOService.writeToCSV(addBookName, addressBook);
			        System.out.println("AddressBook saved to CSV successfully.");
			    } catch (Exception e) {
			        System.out.println("Error saving CSV: " + e.getMessage());
			    }
			    break;

			case 17: // Load AddressBook from CSV
			    try {
			        AddressBook loadedCSV = AddressBookCSVIOService.readFromCSV(addBookName);
			        addressBook.getContacts().clear();
			        addressBook.getContacts().addAll(loadedCSV.getContacts());
			...
			case 18: // Save AddressBook to JSON
			    try {
			        AddressBookJSONIOService.writeToJSON(addBookName, addressBook);
			...
			case 19: // Load AddressBook from JSON
			    try {
			        AddressBook loadedJSON = AddressBookJSONIOService.readFromJSON(addBookName);
			        addressBook.getContacts().clear();
			        addressBook.getContacts().addAll(loadedJSON.getContacts());
